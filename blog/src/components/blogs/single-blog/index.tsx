...
export default function SingleBlog({ blogitem, handleDelete }: { blogitem: Blog ,
    ...
    <div>
      <div className="relative overflow-hidden rounded-md bg-white shadow-one dark:bg-dark">
        <Link className="relative block h-[250px] w-full" href={"/"}>
          ...
          <Image src={image} className="object-cover" alt="Blog Post" fill />
        </Link>
      </div>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center xl:mr-3 xl:pr-3 2xl:mr-5 2xl:pr-5">
            ...
            <div className="flex flex-col">
              ...
              <p className="mb-1 text-sm font-small text-dark dark:text-white">
