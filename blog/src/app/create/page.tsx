...
const stroage = getStorage(app, "gs://nextjs-blog-typescript-2-2f402.appspot.com");
                ...
                {formControls.map((control) => (
                  <div className="w-full px-4" key={control.label}>
                    ...
                    </label>
                    {
                        ...
                        <input type={control.type} name={control.id} placeholder={control.placeholder} onChange={(event : React.ChangeEvent<HTMLInputElement>) => {
                          setFormData({
                            ...formData,
                        ...
                        <textarea placeholder={control.placeholder} name={control.id} 
                        ...
                        rows={6} className="w-full resize-none rounded-md border border-transparent py-3 px-6 text-base text-body-color placeholder-body-color shadow-one outline-none focus:border-primary focus-visible:shadow-none dark:bg-[#242B51] dark:shadow-signUp"/> :
