...
export default function Search() {
    const { searchResults, setSearchQuery, setSearchResults, searchQuery } = useContext(GlobalContext);
                        ...
                        <div className="-mx-4 flex flex-wrap">
                            {
                                ...
                                searchResults.map((searchBlogitem : Blog)=> <div
